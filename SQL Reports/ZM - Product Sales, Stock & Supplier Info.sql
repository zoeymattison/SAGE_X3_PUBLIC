...
SalesData AS (
    SELECT
        ...
        SUM(CASE WHEN SIV.SALFCY_0 = 'DC30' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesDC30,
        SUM(CASE WHEN SIV.SALFCY_0 = 'DC31' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesDC31,
        SUM(CASE WHEN SIV.SALFCY_0 = 'DC33' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesDC33,
        SUM(CASE WHEN SIV.SALFCY_0 = 'DC52' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesDC52,
        SUM(CASE WHEN SIV.SALFCY_0 = '1200' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesDuncan,
        SUM(CASE WHEN SIV.SALFCY_0 = '1600' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesCourt,
        SUM(CASE WHEN SIV.SALFCY_0 = '1800' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesPH,
        SUM(CASE WHEN SIV.SALFCY_0 = '2100' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesFort,
        SUM(CASE WHEN SIV.SALFCY_0 = '2200' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesOak,
        SUM(CASE WHEN SIV.SALFCY_0 = '2300' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesBroad,
        SUM(CASE WHEN SIV.SALFCY_0 = '2400' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesRylOak,
        SUM(CASE WHEN SIV.SALFCY_0 = '2500' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesTusc,
        SUM(CASE WHEN SIV.SALFCY_0 = '2600' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesSidney,
        SUM(CASE WHEN SIV.SALFCY_0 = '2700' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesFortIB,
        SUM(CASE WHEN SIV.SALFCY_0 = '2800' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS SalesSidneyIB,
        SUM(CASE WHEN SIV.SALFCY_0 = '3200' THEN SID.AMTNOTLIN_0 ELSE 0 END) AS Sales3200,
        SUM(SID.AMTNOTLIN_0) AS TotalSales
