 ( BPR_0 , BPRNAM_0 , OVER45AMT_0 , NUM_0 , DUDDAT_0 , COLTYP_0 , AMOUNT_0 
 , OWING_0 , EML_0 , TRUEOWE_0 , UPDDATETIME_0 ) As 
with gaccdudate as (
	select
		d.NUM_0 as [Number],
		TYP_0 as [Type],
...
Where (d.[Collections Type] in ('OVER10','OVER30') or (d.[Collections Type]='OVER45' and s.[Tot. Amt>$100 & 45d]>=100)) and t.Owing>=1 and d.Owing>=1
