SELECT
CONVERT(VARCHAR, PRE.CREDAT_0, 101) AS 'DATE CREATED',
PRE.ORINUM_0 AS 'ORDER NUMBER',
PRE.ITMREF_0 AS 'PRODUCT',
PRE.ITMDES1_0 AS 'DESCRIPTION',
PRE.AUUID_0 AS 'UNIQUE IDENTIFIER',
...
LEFT OUTER JOIN LIVE.SORDER SOH ON PRE.ORINUM_0 = SOH.SOHNUM_0

WHERE PRE.CREDAT_0 BETWEEN '20240401' AND '20240831'

ORDER BY PRE.CREDAT_0, SOH.STOFCY_0
