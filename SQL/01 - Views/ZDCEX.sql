 ( ITMREF_0 , ITMDES_0 , STATS_0 , ACCCOD_0 , CLASS_0 , STU_0 , LOCATIONS_0 
 , ASTK_0 , QSTK_0 , RSTK_0 , TSTK_0 , QTY_SOLD_0 , ANNUAL_QTY_0 , IDEAL_STK_0 
 , EXCESS_STK_0 , EXCESS_STK_A_0 , PRIMARY_V_0 , SECOND_V_0 ) As 
with products as (
    select
