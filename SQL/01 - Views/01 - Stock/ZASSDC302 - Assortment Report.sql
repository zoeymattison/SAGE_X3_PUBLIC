 ( ITMREF_0 , ITMDES_0 , AVC_0 , PL2PRI_0 , MONKSTA_0 , DC30SALES_0 , DC30STK_0 
 , POQTY_0 , POBPS_0 , PODAT_0 , LASTINV_0 , DAYS_0 , BUCKET_0 , INSTOCK_0 
 , DAYSINSTOCK_0 , DAYBUCK_0 , CLASSNAM_0 , AVGVAL_0 , PRIMARYSUP_0 , ACCCOD_0 
 , BUCKET030_0 , BUCKET3160_0 , BUCKET6190_0 ) As 
...
SELECT
    ...
    CASE
        WHEN DATEDIFF(DAY, li.INVDAT_0, GETDATE()) BETWEEN 0  AND 180  THEN '0-180'
        WHEN DATEDIFF(DAY, li.INVDAT_0, GETDATE()) BETWEEN 181 AND 365  THEN '181-365'
        WHEN DATEDIFF(DAY, li.INVDAT_0, GETDATE()) >= 366            THEN '366 Plus'
    END AS [Bucket],
    v.ZINSTOCKDAT_0 AS [In Stock Since],
    DATEDIFF(DAY, v.ZINSTOCKDAT_0, GETDATE()) AS [Days in Stock],
    CASE
        WHEN DATEDIFF(DAY, v.ZINSTOCKDAT_0, GETDATE()) BETWEEN 0  AND 180  THEN '0-180'
        WHEN DATEDIFF(DAY, v.ZINSTOCKDAT_0, GETDATE()) BETWEEN 181 AND 365  THEN '181-365'
        WHEN DATEDIFF(DAY, v.ZINSTOCKDAT_0, GETDATE()) >= 366            THEN '366 Plus'
    END AS [DIS Bucket],
