 ...
 , DC33STK_0 , POQTY_0 , POBPS_0 , PODAT_0 , LASTINV_0 , CLASSNAM_0 , AVGVAL_0 
 , PRIMARYSUP_0 , ACCCOD_0 ) As 
WITH SalesPrice AS (
    SELECT
        PLICRI2_0,
        PRI_0,
...
SELECT
    ...
    ISNULL(CD.[Average Cost],0)*(ISNULL(SSD.StockTotalDC30,0)+ISNULL(SSD.StockTotalDC33,0)) as [Avg Value On Hand],
