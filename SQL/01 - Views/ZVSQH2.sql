 ( SOHNUM_0 , LINE_0 , PRODUCT_0 , DESCRIPTION_0 , CATALOGUE_0 , ORDERED_0 
 , AVAILABLE_0 , BACKORDERED_0 , SALESUNIT_0 , GROSSPRICE_0 , DISCOUNT_0 
 , OPTIONS_0 , TOTAL_0 , LINETEXT_0 ) As 
with SORDERLINES as (
	select
