...
WHERE 
  ...
  AND SOQ.BPCORD_0 NOT IN ('ICR53','ICR54','ICR55','ICR56','ICR57','ICR58','ICR59','ICR60','ICR61','ICR62','ICR63','1200','1300','1400','1500','1600','1700','1800','1900','2000','2100','2200','2300','2400','2500','2600','2700','2800','IDC30','IDC31','IDC33','IDC52')
  AND SOP.REP1_0 NOT IN ('37','54','2221','88')
  AND SOQ.STOFCY_0='DC30'
  AND ITM.CCE_1<>'TS' and ITM.TSICOD_1 not in ('8029','8030','2713','8020','8023','8045','8025','8010','8040','5200','5250','5275')
GROUP BY 
  SOQ.CREDAT_0,
  REP.REPNAM_0,
  SOQ.SOHNUM_0, 
