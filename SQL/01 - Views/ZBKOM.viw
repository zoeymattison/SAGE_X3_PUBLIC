 ( CREDAT_0 , LINSTA_0 , REP_0 , SOHNUM_0 , CUSORDREF_0 , SOHTYP_0 , HLDCOD_0 
 , STOFCY_0 , BPCORD_0 , ITMREF_0 , ITMDES_0 , TSICOD_0 , ABCCOD_0 
 , ALTERNATE_0 , ALTERNDES_0 , ORDERED_0 , REMAINING_0 , ALLOCATED_0 , DC30OH_0 
 , DC33OH_0 , COURTOH_0 , FORTOH_0 , OAKOH_0 , BROADOH_0 , SIDNEYOH_0 
 , TOTALOH_0 , POHNUM_0 , POHETA_0 , POHBPS_0 , PIOBPS_0 , BPSMOQ_0 
 , DC30SAL1_0 , DC30SAL3_0 , DC30SALY_0 , DC33SAL1_0 , DC33SAL3_0 , DC33SALY_0 
 , ALLSAL1_0 , ALLSAL3_0 , ALLSALY_0 , RETSAL1_0 , RETSAL3_0 , RETSALY_0 
 , CREDATTIM_0 , DME_0 ) As 
SELECT 
...
CAST(
    cast(SOQ.CREDATTIM_0 as datetime2) 
    AT TIME ZONE 'UTC' 
    AT TIME ZONE 'Pacific Standard Time' 
AS datetime2),
Case SOH.DME_0
	when 1 then 'Ship partial'
	When 2 then 'Ship line complete'
	When 3 then 'Ship order complete'
End
FROM 
  LIVE.SORDERQ SOQ 
  ...
  LEFT OUTER JOIN LIVE.SORDERP SOP ON SOQ.SOHNUM_0 = SOP.SOHNUM_0 AND SOQ.SOPLIN_0 = SOP.SOPLIN_0 AND SOQ.SOQSEQ_0 = SOP.SOPSEQ_0
  LEFT OUTER JOIN LIVE.SALESREP REP ON SOP.REP1_0 = REP.REPNUM_0
  LEFT OUTER JOIN (
    SELECT 
      ITMREF_0,
  ...
  LEFT OUTER JOIN (
    SELECT 
      ITMREF_0,
      MAX(CASE WHEN LEFT(POQ.POHNUM_0,2)='PO' AND LEFT(BPS.BPSNUM_0,1)='V' AND LINCLEFLG_0 = 1 and POH.BETFCY_0=1 THEN POQ.POHNUM_0 ELSE NULL END) AS EARLIEST_PO,
      MAX(CASE WHEN LEFT(POQ.POHNUM_0,2)='PO' AND LEFT(BPS.BPSNUM_0,1)='V' AND LINCLEFLG_0 = 1 and POH.BETFCY_0=1 THEN EXTRCPDAT_0 ELSE NULL END) AS ETA,
      MAX(CASE WHEN LEFT(POQ.POHNUM_0,2)='PO' AND LEFT(BPS.BPSNUM_0,1)='V' AND LINCLEFLG_0 = 1 and POH.BETFCY_0=1 THEN BPSNAM_0 + ' - ' + BPS.BPSNUM_0 ELSE NULL END) AS PO_VENDOR
    FROM 
      LIVE.PORDERQ POQ 
      LEFT OUTER JOIN LIVE.BPSUPPLIER BPS ON POQ.BPSNUM_0 = BPS.BPSNUM_0
	  inner join LIVE.PORDER POH on POQ.POHNUM_0=POH.POHNUM_0
    GROUP BY 
      ITMREF_0
...
WHERE 
  ...
  AND (SOQ.QTYSTU_0-(SOQ.ALLQTYSTU_0+SOQ.PREQTYSTU_0+SOQ.DLVQTYSTU_0) > 0 AND SOQ.QTYSTU_0-(SOQ.ALLQTYSTU_0+SOQ.OPRQTYSTU_0+SOQ.TDLQTYSTU_0) > 0
  AND SOQ.QTYSTU_0-(SOQ.ALLQTYSTU_0+SOQ.PREQTYSTU_0+SOQ.TDLQTYSTU_0) > 0)
  AND SOQ.BPCORD_0 NOT IN ('IDC30','IDC31','IDC33','IDC52')
  AND SOP.REP1_0 NOT IN ('37','54','2221','88')
  AND (ITM.CCE_1='TS' or ITM.TSICOD_1 in ('8029','8030','2713','8020','8023','8045','8025','8010','8040','5200','5250','5275'))
GROUP BY 
  SOQ.CREDAT_0,
  REP.REPNAM_0,
  SOQ.SOHNUM_0, 
