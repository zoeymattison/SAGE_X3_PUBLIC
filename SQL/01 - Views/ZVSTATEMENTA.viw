 ( DUDDAT_0 , NUMBER_0 , TYP_0 , SOHNUM_0 , PAYBY_0 , PURCHASEORD_0 
 , LINE_SUB_0 , DISC_TOT_0 , FREIGHT_0 , FUEL_CHARGE_0 , SUBTOTAL_0 , EHF_FEE_0 
 , GST_0 , PST_0 , TOTAL_0 , OWING_0 ) As 
with gaccdudate as (
	select
		NUM_0 as [Number],
		TYP_0 as [Type],
