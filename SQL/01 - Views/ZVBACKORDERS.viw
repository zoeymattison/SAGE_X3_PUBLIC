 ( STOFCY_0 , SOHNUM_0 , ITMREF_0 , ITMDES_0 , MNKSTA_0 , QTY_0 , BKO_0 , UOM_0 
 , EXPECTED_0 , MISSING_0 , PRIORITY_0 , CREATED_0 ) As 
WITH StockTotals AS (
    SELECT
        ITMREF_0,
        STOFCY_0,
...
b2b_raw AS (
    SELECT
        ...
        SUM(o.SHTQTY_0) OVER (
            ...
            ORDER BY q.SOHNUM_0, q.SOPLIN_0 asc
        ) AS [RunningDemand],
q.CREDATTIM_0,
...
CAST(YEAR(f.CREDATTIM_0) AS varchar(4))
+ RIGHT('0' + CAST(MONTH(f.CREDATTIM_0) AS varchar(2)), 2)
+ RIGHT('0' + CAST(DAY(f.CREDATTIM_0) AS varchar(2)), 2)
+ RIGHT('0' + CAST(DATEPART(HOUR, f.CREDATTIM_0) AS varchar(2)), 2)
+ RIGHT('0' + CAST(DATEPART(MINUTE, f.CREDATTIM_0) AS varchar(2)), 2)
+ RIGHT('0' + CAST(DATEPART(SECOND, f.CREDATTIM_0) AS varchar(2)), 2)
AS CreationDate
