 ( SALFCY_0 , CREDAT_0 , ORDDAT_0 , SHIDAT_0 , SOHNUM_0 , COSTCNTR_0 , POHNUM_0 
 , SALESREP_0 , ROUTE_0 , PAYTRM_0 , PIKTIKNTE_0 , TAXRULE_0 , BILLTO_0 
 , BILLTO_NAME1_0 , BILLTO_NAME2_0 , BILLTO_ADDR1_0 , BILLTO_ADDR2_0 
 , BILLTO_ADDR3_0 , BILLTO_CRYCD_0 , BILLTO_CRYNM_0 , BILLTO_CTYNM_0 
 , BILLTO_PRVCD_0 , BILLTO_POSCD_0 , BILLTO_EMAIL_0 , SHPTO_0 , SHPTO_NAME1_0 
 , SHPTO_NAME2_0 , SHPTO_ADDR1_0 , SHPTO_ADDR2_0 , SHPTO_ADDR3_0 
 , SHPTO_CRYCD_0 , SHPTO_CRYNM_0 , SHPTO_CTYNM_0 , SHPTO_PRVCD_0 
 , SHPTO_POSCD_0 , SHIPT_EMAIL_0 , LINEDISCOUNT_0 , INVELMDSCTOT_0 
 , TOTALDISCNT_0 , INV_ELM_FRT_0 , INV_ELM_FSC_0 , LINESUBTOTAL_0 
 , ORDSUBTOTAL_0 , TAX_EHF_0 , TAX_GST_0 , TAX_PST_0 , INV_TOTAL_0 
 , INV_OWING_0 , TEXT_HEADER_0 , TEXT_FOOTER_0 ) As 
with BPDLVCUST as (
	select
...
distinct
	...
	/* DISCOUNTS */
	sol.[Line Discounts],
	isnull(svf.[SO Discount]+svf.[SO Discount Percent-Amount]+svf.[Web Discount],0) as [SO Discounts],
	isnull(sol.[Line Discounts]+svf.[SO Discount]+svf.[SO Discount Percent-Amount]+svf.[Web Discount],0) as [Total Discounts],
	/* INVOICING ELEMENTS */
