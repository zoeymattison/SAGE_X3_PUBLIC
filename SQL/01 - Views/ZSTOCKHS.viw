 ( STOFCY_0 , ITMREF_0 , ITMDES1_0 , MNKSTA_0 , MNKCLS_0 , MNKCLSDES_0 
 , MNKCAT_0 , ABCCLS_0 , STOQTY_0 , STOUOM_0 , LOC_0 , LOCTYP_0 , AVC_0 
 , AVCTOT_0 , SAFSTO_0 , RCPDATMAX_0 , RCPDATMIN_0 , MRCCNTMAX_0 , INVDATMAX_0 
 , DAYS_0 ) As 
WITH AggDates AS (
    SELECT
        ITMREF_0,
