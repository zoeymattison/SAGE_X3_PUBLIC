 ( SALFCY_0 , CREDAT_0 , ACCDAT_0 , INVDAT_0 , DUEDATE_0 , NUM_0 , SOHNUM_0 
 , SIHORINUM_0 , COSTCNTR_0 , SNSTYP_0 , POHNUM_0 , SALESREP_0 , ROUTE_0 
 , PAYTRM_0 , PIKTIKNTE_0 , TAXRULE_0 , BILLTO_0 , EDD_0 , BILLTO_NAME1_0 
 , BILLTO_NAME2_0 , BILLTO_ADDR1_0 , BILLTO_ADDR2_0 , BILLTO_ADDR3_0 
 , BILLTO_CRYCD_0 , BILLTO_CRYNM_0 , BILLTO_CTYNM_0 , BILLTO_PRVCD_0 
 , BILLTO_POSCD_0 , BILLTO_EMAIL_0 , SHPTO_0 , SHPTO_NAME1_0 , SHPTO_NAME2_0 
 , SHPTO_ADDR1_0 , SHPTO_ADDR2_0 , SHPTO_ADDR3_0 , SHPTO_CRYCD_0 
 , SHPTO_CRYNM_0 , SHPTO_CTYNM_0 , SHPTO_PRVCD_0 , SHPTO_POSCD_0 
 , SHIPT_EMAIL_0 , PAYBY_0 , PAYBY_NAME1_0 , PAYBY_NAME2_0 , PAYBY_ADDR1_0 
 , PAYBY_ADDR2_0 , PAYBY_ADDR3_0 , PAYBY_CRYCD_0 , PAYBY_CRYNM_0 
 , PAYBY_CTYNM_0 , PAYBY_PRVCD_0 , PAYBY_POSCD_0 , PAYBY_EMAIL_0 , LINESUBTOT_0 
 , LINEDISCOUNT_0 , INVDISCAMT_0 , INVDISCPAMT_0 , INVDISCTOT_0 , INV_ELM_FRT_0 
 , INV_ELM_FSC_0 , INV_ELM_RSF_0 , INV_SUBTOTAL_0 , TAX_EHF_0 , TAX_GST_0 
 , TAX_PST_0 , INV_TOTAL_0 , INV_REMAIN_0 , INV_OWINGBAL_0 , TYPE_INV_0 
 , TYPE_SOH_0 , BPRVCR_0 , COMMENTS_0 ) As 
with SINVOICEV as (
	select
...
isnull((zsiv.[Web Discount]+zsiv.[Invoice $ Discount])*zsih.SNS_0,0) as [Invoice $ Discounts],
...
isnull(Case when zsiv.[Discount Percent]>0 then
(zsid.[Line Amount (After Discounts)]-zsih.AMTNOT_0)*zsih.SNS_0 else 0 end+(zsiv.[Web Discount]+zsiv.[Invoice $ Discount]+zsid.[Line Discounts])*zsih.SNS_0,0) as [Total Discounts],
/* Invoicing Elements */
