 ( CREDAT_0 , RECEIVER_0 , BPS_0 , POHNUM_0 , OCNNUM_0 , PTHNUM_0 , PNHNUM_0 
 , DEBMEM_0 , ITMREF_0 , ITMREFBPS_0 , ITMDES1_0 , QTY_0 , UOM_0 , NOTES_0 
 ) As 
SELECT
...
LEFT JOIN LIVE.PORDER POH ON PTD.POHNUM_0=POH.POHNUM_0
Where ZERRQTY_0>0
