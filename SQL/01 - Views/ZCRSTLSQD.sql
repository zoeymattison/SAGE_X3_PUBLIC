 ( CREDAT_0 , SQHNUM_0 , ITMREF_0 , ITMDES1_0 , ITMDES2_0 , ITMDES3_0 
 , UPCNUM_0 , BASNUM_0 , MNKSTA_0 , QTYORD_0 , QTYSAU_0 , GROPRI_0 , CSTPRI_0 
 , NETPRI_0 , GSTPRI_0 , GSTAMT_0 , PSTPRI_0 , PSTAMT_0 , EHFPRI_0 , EHFAMT_0 
 , NETPRITAX_0 , TOTPRI_0 , TOTPRITAX_0 , QTYSTOCK_0 ) As 
With ProductInfo As (
	SELECT
		ITMREF_0,
		ITMDES1_0,
...
StockQuantity As (
	SELECT
		ITMREF_0,
		SUM(QTYSTU_0-CUMALLQTY_0) as QTY_0
	FROM
		LIVE.STOCK
	WHERE STA_0='A' and STOFCY_0='DC30'
	GROUP BY ITMREF_0
)
SELECT
...
LEFT JOIN StockQuantity STO ON ITM.ITMREF_0=STO.ITMREF_0
