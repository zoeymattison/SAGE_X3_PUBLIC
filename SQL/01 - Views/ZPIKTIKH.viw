 ( PICKTICK_0 , PLAN_0 , SALESORDER_0 , ORDERDATE_0 , ROUTE_0 , PRIORITY_0 
 , INSTRUCTIONS_0 , STUDENT_NAME_0 , STUDENT_GRAD_0 , PARENT_NAME_0 
 , PURCHASE_ORD_0 , CONTACT_NAM_0 , CONTACT_PHN_0 , INSTALL_DAT_0 , SHIP_SITE_0 
 , SITE_NAME_0 , BILLTO_0 , BILLTO_N1_0 , BILLTO_N2_0 , BILLTO_A1_0 
 , BILLTO_A2_0 , BILLTO_A3_0 , BILLTO_CT_0 , BILLTO_PV_0 , BILLTO_PC_0 
 , BILLTO_CY_0 , SHIPTO_0 , SHIPTO_N1_0 , SHIPTO_N2_0 , SHIPTO_A1_0 
 , SHIPTO_A2_0 , SHIPTO_A3_0 , SHIPTO_CT_0 , SHIPTO_PV_0 , SHIPTO_PC_0 
 , SHIPTO_CY_0 , REPNAME_0 , WEBNAM_0 , WEBEML_0 , WEBTEL_0 , HEADFOOT_0 ) As 
with picktick_header as (
	select
		...
		cast(isnull(t1.TEXTE_0,'') as nvarchar(max)) as [Header Text],
		cast(isnull(t2.TEXTE_0,'') as nvarchar(max)) as [Footer Text],
