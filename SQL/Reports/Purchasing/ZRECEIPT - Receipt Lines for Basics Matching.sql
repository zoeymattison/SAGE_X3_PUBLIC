...
WHERE PTD.CREDAT_0>=FORMAT(DATEADD(day, -60, GETDATE()), 'yyyyMMdd') and PRHFCY_0='DC30' and PTD.BPSINV_0='V5555' and LEFT(ITP.ITMREF_0,1)<>'/' and ((SELECT
SUM(QTYUOM_0)
FROM LIVE.PINVOICED
