...
left join
	invoicelines ivl_check on ivl_check.NUM_0 = sih.NUM_0 
		and ivl_check.[Invoice Line Number] = sol.SOPLIN_0
left join
...
left join
	bp_invoice_lines bp on sih.NUM_0=bp.[Invoice]

where 
	 (
		son.SOHNUM_0 IS NULL  /* No sales order (interest lines, etc) */
		OR son.SOHNUM_0 = ''  /* Direct invoice lines */
		OR sol.[Sales order INV NUM] = sih.NUM_0  /* Sales order line is on this invoice */
		OR ivl_check.NUM_0 IS NULL  /* Sales order line is NOT on this invoice */
	)